...
*Attention:* sur mon PC portable j'ai un mode économie d'énergie qui a le facheux défaut de ralentir
considérablement le temps de lancement d'Emacs en mode GUI. Le temps de lancement passe de 2s à plus de 5s.
